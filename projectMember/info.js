(function ($$, doc, $) {
  ...
  mui.ready(function () {
    ...
    function initData () {
      $('#authorPicMax').attr('src', url + '20191221002848830769511.png')
      $('#authorPicMin').attr('src', url + '20191221002848830769511.png')
    ...
    mui('body').on('tap', '#sendMessage', function () {
      mui.openWindow({
        url: '/chat/chatDetail.html?staffId=' + info.userId,
        id: 'chatDetail'
      })
    })
  });
