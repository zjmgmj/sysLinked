(function ($$, doc, $) {
  ...
  mui.ready(function () {
    ...
    mui('.popup').on('tap', '#inviteMembers', function () {
      mui.openWindow({
        url: '/organizationMember/createInvite.html',
        id: 'createInvite'
      })
    })
    ...
    mui('.organization').on('tap', '.member-li', function () {
      ...
      mui.openWindow({
        url: '/organizationMember/members.html?type=' + type + '&orgId=' + orgId + '&status=' + status + '&title=' + title,
        id: 'membersList'
      })
    })
    ...
    mui('#deptList').on('tap', '.dept', function () {
      ...
      mui.openWindow({
        url: '/organizationMember/members.html?type=' + type + '&orgId=' + orgId + '&deptId=' + deptId + '&pid=' + pid,
        id: 'deptMemberList'
      })
    })
    // orguserList()
